...
values 
('Fixflex', 'montreal,171 New Castle Crossing'),
('Sonair', 'montreal,9 Barby Road'),
('Mat Lam Tam', 'montreal,04095 Holy Cross Center'),
('Asoka', 'montreal,6 Welch Crossing'),
('Fixflex', 'montreal,347 Menomonie Crossing'),
('Daltfresh', 'montreal,8 Donald Hill'),
('Y-find', 'montreal,5 Declaration Junction'),
('Toughjoyfax', 'montreal,2 Tony Parkway'),
('Flowdesk', 'montreal,76 Prairie Rose Park'),
('Prodder', 'montreal,34 Basil Parkway');
